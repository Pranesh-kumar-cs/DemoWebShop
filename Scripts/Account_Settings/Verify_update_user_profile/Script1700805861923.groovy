...
WebUI.doubleClick(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_Email_Email'))

WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_Email_Email'), 'Testabcxyz1234@test.com')

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_First name_FirstName'))
...
WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_Last name_LastName'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Account/a_Addresses'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_India_button-2 edit-address-button'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_City_Address.City'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_Address 2_Address.Address2'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_Address 2_Address.Address2'))

WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Account/input_Address 2_Address.Address2'), 'Home')
