...
WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Build your own cheap computer/a_446                    review(s)'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Product Reviews. Build _40d5f5/div_test                                   _a55ded'))

WebUI.click(findTestObject('Object Repository/Page_Demo Web Shop. Product Reviews. Build _40d5f5/strong_test'))
